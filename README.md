...
| View integration test report (Maven) | View the integration test report file if it exists at `target/site/failsafe-report.html` if Liberty dev mode used report plugin v3.4 or earlier or `target/reports/failsafe.html` otherwise.                                                                                                                                                                                                                             |
| View unit test report (Maven)        | View the unit test report file if it exists at `target/site/surefire-report.html`  if Liberty dev mode used report plugin v3.4 or earlier or `target/reports/surefire.html` otherwise.                                                                                                                                                                                                                                   |
