...
> Note: Requires a minimum of **IntelliJ IDEA 2023.1** and **Java 17**. For the latest supported IntelliJ versions, see the [latest release notes](https://github.com/OpenLiberty/liberty-tools-intellij/releases/latest).
>
