...
public class UIBotTestUtils {
    ...
    public static void createLibertyConfigurationWithCustomParams(RemoteRobot remoteRobot, String cfgName) {
        ProjectFrameFixture projectFrame = remoteRobot.find(ProjectFrameFixture.class, Duration.ofSeconds(10));
        ComponentFixture runMenu = projectFrame.getActionMenu("Run", "10");
        runMenu.click();
        ComponentFixture editCfgsMenuEntry = projectFrame.getActionMenuItem("Edit Configurations...");
        ...
        try {
            ...
            // Ensure the name of the config appears in the text box
            RepeatUtilsKt.waitFor(Duration.ofSeconds(5),
                    Duration.ofSeconds(1),
                    "Waiting for the name of the config to appear in the text box",
                    "The name of the config did not appear in the text box ",
            ...
            // Save the new configuration by clicking on the Apply button.
            JButtonFixture applyButton = addProjectDialog.button("Apply"); // Use button instead of getButton
            applyButton.click(); // Use requireEnabled() to ensure the button is enabled
            exitButtonText = "OK"; // Update exitButtonText after successful click
        } finally {
            // Exit the Run/Debug Configurations dialog.
            JButtonFixture exitButton = addProjectDialog.button(exitButtonText); // Use button instead of getButton
            exitButton.click(); // Use requireEnabled() to ensure the button is enabled
        }
    }
