 ...
 *******************************************************************************/
package io.openliberty.tools.intellij.lsp4jakarta.it.faces;
...
public class JakartaFacesTest extends BaseJakartaTest {
    ...
    public void implementFacesValidator() throws Exception {
        ...
        VirtualFile javaFile = LocalFileSystem.getInstance().refreshAndFindFileByPath(ModuleUtilCore.getModuleDirPath(module)
                + "/src/main/java/io/openliberty/sample/jakarta/faces/DontImplementValidator.java");
    ...
    public void facesValidatorWithValidatorInterface() throws Exception {
        ...
        VirtualFile javaFile = LocalFileSystem.getInstance().refreshAndFindFileByPath(ModuleUtilCore.getModuleDirPath(module)
                + "/src/main/java/io/openliberty/sample/jakarta/faces/ImplementsValidator.java");
        String uri = VfsUtilCore.virtualToIoFile(javaFile).toURI().toString();
