 ...
 * The entity has a @OneToOne @Id field whose parent entity (Department) has a simple
 * int primary key. The key class holds String for that field instead of int.
 * Expects:
 *   - IdClassMemberTypeMismatch on @Id field "dept"
 */
@Entity
@IdClass(IdClassOneToOneTypeMismatchPK.class)
public class IdClassOneToOneTypeMismatch {
    ...
    public IdClassOneToOneTypeMismatch() {
    }
}
