...
*******************************************************************************/
package io.openliberty.tools.intellij.lsp4mp4ij.psi.core.java.inlayhint;

import com.intellij.openapi.extensions.ExtensionPointName;
import com.intellij.psi.JavaRecursiveElementVisitor;
import io.openliberty.tools.intellij.lsp4mp4ij.psi.internal.core.java.inlayhint.JavaASTInlayHintExtensionPointBean;
...
public class JavaASTInlayHint extends JavaRecursiveElementVisitor implements Cloneable {
	...
	public static final ExtensionPointName<JavaASTInlayHintExtensionPointBean> EP_NAME = ExtensionPointName.create("open-liberty.intellij.javaASTInlayHint.inlayHint");
