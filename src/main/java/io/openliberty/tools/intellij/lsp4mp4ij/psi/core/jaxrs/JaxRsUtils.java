...
public class JaxRsUtils {
	...
	public static String getJaxRsPathValue(PsiElement annotatable) {
		PsiAnnotation annotationPath = AnnotationUtils.getFirstAnnotation(annotatable, JAVAX_WS_RS_PATH_ANNOTATION,
				JAKARTA_WS_RS_PATH_ANNOTATION);
		if (annotationPath == null) {
			return null;
		}
		return AnnotationUtils.getAnnotationMemberValue(annotationPath, PATH_VALUE);
	}
	...
	public static String getJaxRsApplicationPathValue(PsiElement annotatable) {
		PsiAnnotation annotationApplicationPath = AnnotationUtils.getFirstAnnotation(annotatable, JAVAX_WS_RS_APPLICATIONPATH_ANNOTATION,
				JAKARTA_WS_RS_APPLICATIONPATH_ANNOTATION);
		if (annotationApplicationPath == null) {
			return null;
		}
		return AnnotationUtils.getAnnotationMemberValue(annotationApplicationPath, PATH_VALUE);
	}
	...
	public static boolean isClickableJaxRsRequestMethod(PsiMethod method) {
		return AnnotationUtils.hasAnyAnnotation(method, JAVAX_WS_RS_GET_ANNOTATION, JAKARTA_WS_RS_GET_ANNOTATION);
	}
