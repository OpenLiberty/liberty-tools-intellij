...
import io.openliberty.tools.intellij.lsp4mp4ij.psi.internal.config.java.MicroProfileConfigErrorCode;
...
public class JavaDiagnosticsContext extends AbstractJavaContext {
	...
	public JavaDiagnosticsContext(String uri, PsiFile typeRoot, IPsiUtils utils, @NotNull Module module, DocumentFormat documentFormat, @Nullable MicroProfileJavaDiagnosticsSettings settings, @NotNull List<Diagnostic> diagnostics) {
