...
public class InsertPublicNoArgConstructorQuickFix implements IJavaCodeActionParticipant {
    ...
    public List<? extends CodeAction> getCodeActions(JavaCodeActionContext context, Diagnostic diagnostic) {
        ...
        if (parentType != null) {
            ...
            CodeAction codeAction = JDTUtils.createCodeAction(context, diagnostic, constructorName, getParticipantId());
    ...
    public CodeAction resolveCodeAction(JavaCodeActionResolveContext context) {
        ...
        ChangeCorrectionProposal proposal = new AddConstructorProposal(
                constructorName,
        ...
        ExceptionUtil.executeWithWorkspaceEditHandling(
                ...
                toResolve,
                LOGGER,
                "Unable to create workspace edit for code action to add public no-arg constructor");
        return toResolve;
    }
