...
*******************************************************************************/
package com.langserver.devtools.intellij.lsp4mp4ij.psi.internal.jul.properties;

import com.intellij.openapi.module.Module;
import com.langserver.devtools.intellij.lsp4mp4ij.psi.core.AbstractStaticPropertiesProvider;
...
public class JBossLogManagerPropertyProvider extends AbstractStaticPropertiesProvider {
	...
	public JBossLogManagerPropertyProvider() {
		super("/static-properties/jboss-logmanager-metadata.json",
				IPropertiesCollector.MergingStrategy.REPLACE /* JUL 'INFO' must be overrided with JBossLogManager 'INFO' */);
	}
