...
When installing the LTI Plugin, the latest version of LSP4IJ from the marketplace will be installed by default.

If you prefer to use an older version of LSP4IJ (e.g., the specific version that was tested with the LTI release you are using), you can manually downgrade it by installing the desired version as a dependency from the Marketplace. Link to download a specific LSP4IJ version - https://plugins.jetbrains.com/plugin/23257-lsp4ij/versions
